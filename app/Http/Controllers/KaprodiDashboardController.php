...
class KaprodiDashboardController extends Controller
{
    public function dashboard()
    {
        ...
        $prodis = Prodi::with('profillulusans')
        ...
        foreach ($prodis as $prodi) {
            ...
            // Assign progress to prodi object
        ...
        return view('kaprodi.dashboard', compact('prodis', 'prodicount', 'ProdiSelesai', 'ProdiProgress', 'ProdiBelumMulai'));
    }
}
