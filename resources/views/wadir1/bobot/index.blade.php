...
@section('content')
    <div class="bg-white p-4 md:p-6 lg:p-8 rounded-lg shadow-md mx-2 md:mx-0">
        ...
        {{-- <a href="{{ route('wadir1.bobot.create') }}" class="px-4 py-2 bg-blue-500 text-white rounded-lg mb-4 inline-block">
            Tambah Bobot CPL-MK
        </a> --}}
                    ...
                    <tr class="{{ $loop->even ? 'bg-gray-100' : 'bg-white' }} hover:bg-gray-200 border-b align-top">
                        ...
                        <td class="px-3 py-2 md:px-6 md:py-4">
                            <div class="flex justify-center space-x-1 md:space-x-2">
                                ...
                                {{-- <a href="{{ route('wadir1.bobot.edit', $id_cpl) }}"
                                ...
                                <form action="{{ route('wadir1.bobot.destroy', $id_cpl) }}" method="POST">
                                    @csrf @method('DELETE')
                                    <button type="submit"
