...
@section('content')
    <div class="bg-white p-4 md:p-6 lg:p-8 rounded-lg shadow-md mx-2 md:mx-0">
        ...
        <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-6 gap-4">
            ...
            <a href="{{ route('wadir1.capaianprofillulusan.create') }}" 
                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            @foreach ($capaianprofillulusans as $index => $capaianprofillulusan)
                                <tr class="{{ $index % 2 == 0 ? 'bg-gray-100' : 'bg-white' }} hover:bg-gray-100">
                                    ...
                                    <td class="px-4 py-4">
                                        <div class="flex justify-center space-x-2">
                                            ...
                                            {{-- <a href="{{ route('wadir1.capaianprofillulusan.edit', $capaianprofillulusan->id_cpl) }}" 
                                ...
                                <form action="{{ route('wadir1.capaianprofillulusan.destroy', $capaianprofillulusan->id_cpl) }}" method="POST">
                                    @csrf @method('DELETE')
                                    <button type="submit"
    ...
    <script>
        function updateFilter() {
            ...
            let url = "{{ route('wadir1.capaianpembelajaranlulusan.index') }}";
            let params = [];
