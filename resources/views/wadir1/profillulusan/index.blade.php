...
@section('content')
    <div class="bg-white p-4 md:p-6 lg:p-8 rounded-lg shadow-md mx-2 md:mx-0">
        ...
        <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-6 gap-4">
            {{-- <div class="flex space-x-2">
                <a href="{{ route('wadir1.profillulusan.create') }}"
                                ...
                                <tr class="align-top {{ $index % 2 == 0 ? 'bg-gray-50' : 'bg-white' }} hover:bg-gray-100">
                                    ...
                                    <td class="px-4 py-4 w-32 border border-gray-300">
                                        <div class="flex justify-center space-x-2">
                                            ...
                                            {{-- <a href="{{ route('wadir1.profillulusan.edit', $profillulusan->id_pl) }}"
                                            ...
                                            <form
                                                action="{{ route('wadir1.profillulusan.destroy', $profillulusan->id_pl) }}"
                                                method="POST">
                                                @csrf @method('DELETE')
                                                <button type="submit"
    ...
    <script>
        function updateFilter() {
            ...
            let url = "{{ route('wadir1.profillulusan.index') }}";
            let params = [];
