...
@section('content')
    <div class="bg-white p-4 md:p-6 lg:p-8 rounded-lg shadow-md mx-2 md:mx-0">
        ...
        <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-6 gap-4">
            ...
            <a href="{{ route('wadir1.capaianpembelajaranmatakuliah.create') }}"
                    ...
                    <tr class="{{ $index % 2 == 0 ? 'bg-gray-100' : 'bg-white' }} hover:bg-gray-200 border-b">
                        ...
                        <td class="py-2 px-3 flex justify-center items-center space-x-2 br">
                            <div class="flex justify-center space-x-2">
                                ...
                                {{-- <a href="{{ route('wadir1.capaianpembelajaranmatakuliah.edit', $cpmk->id_cpmk) }}"
                            ...
                            <form
                                action="{{ route('wadir1.capaianpembelajaranmatakuliah.destroy', $cpmk->id_cpmk) }}"
                                method="POST">
                                @csrf @method('DELETE')
                                <button type="submit"
    ...
    <script>
        function updateFilter() {
            ...
            let url = "{{ route('wadir1.capaianpembelajaranmatakuliah.index') }}";
            let params = [];
