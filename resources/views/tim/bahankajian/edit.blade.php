...
<form action="{{ route('tim.bahankajian.update', $bahankajian->id_bk) }}" method="POST">
    ...
    <select id="id_cpls" size="2" name="id_cpls[]" class="border border-gray-300 p-3 w-full rounded-lg mt-1 mb-1 focus:outline-none focus:ring-2 focus:ring-[#5460B5] focus:bg-[#f7faff]" multiple required>
    ...
    <a href="{{ route('tim.bahankajian.index') }}" class="ml-2 bg-gray-600 hover:bg-gray-800 px-5 py-2 rounded-lg text-white font-bold">Kembali</a>
</form>
</div>
@endsection