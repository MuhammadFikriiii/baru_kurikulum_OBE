...
<form action="{{ route ('tim.matakuliah.update',$matakuliah->kode_mk)}}" method="POST">
    ...
    <label for="id_cpls" class="text-xl font-semibold">CPL</label>
...
<br>
    ...
    <button type="submit" class="mt-3 bg-blue-600 hover:bg-blue-800 px-5 py-2 rounded-lg text-white font-semibold">Simpan</button>
    <a href="{{ route('tim.matakuliah.index') }}" class="ml-2 bg-gray-600 hover:bg-gray-800 px-5 py-2 rounded-lg text-white font-semibold">Kembali</a>
</form>
</div>
@endsection