...
<div class="mr-20 ml-20">
    ...
    <hr class="border border-black mb-8">
        ...
        <div>
            ...
            <input type="text" value="{{ $cpmk->kode_cpmk }}" readonly class="w-full bg-gray-100 border border-gray-300 rounded-lg px-4 py-2">
        </div>
        <div>
    ...
    <div class="mb-8">
        ...
        <ul class="list-disc pl-6 text-gray-700">
            @forelse ($cpls as $cpl)
                <li><span class="font-semibold">{{ $cpl->id_cpl }}</span>: {{ $cpl->deskripsi_cpl }}</li>
            @empty
