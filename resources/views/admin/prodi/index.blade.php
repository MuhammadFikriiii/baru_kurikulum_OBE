            ...
            <div class="overflow-x-auto">
                <table class="min-w-full border border-gray-200">
                    <thead class="bg-green-800 text-white">
                        <tr>
                            <th class="px-6 py-3 text-center font-medium uppercase tracking-wider border border-gray-200">No</th>
                            <th class="px-6 py-3 text-center  font-medium uppercase tracking-wider border border-gray-200">Jurusan</th>
                            <th class="px-6 py-3 text-center font-medium uppercase tracking-wider border border-gray-200">Kode Prodi</th>
                            <th class="px-6 py-3 text-center font-medium uppercase tracking-wider border border-gray-200">Nama Prodi</th>
                            <th class="px-6 py-3 text-center font-medium uppercase tracking-wider border border-gray-200">Jenjang</th>
                            <th class="px-6 py-3 text-center  font-medium uppercase tracking-wider border border-gray-200">Akreditasi</th>
                    ...
                    <tbody>
                        ...
                        <tr class="{{ $index % 2 == 0 ? 'bg-gray-50' : 'bg-white' }} hover:bg-gray-100">
                            <td class="px-6 py-4 text-center text-sm border border-gray-200">{{ $index + 1 }}</td>
                            <td class="px-6 py-4 text-center text-sm border border-gray-200">{{ $prodi->jurusan->nama_jurusan ?? '-' }}</td>
                            <td class="px-6 py-4 text-center text-sm border border-gray-200">{{ $prodi->kode_prodi }}</td>
                            <td class="px-6 py-4 text-center text-sm border border-gray-200">{{ $prodi->nama_prodi }}</td>
                            <td class="px-6 py-4 text-center text-sm border border-gray-200">{{ $prodi->jenjang_pendidikan ?? '-' }}</td>
                            <td class="px-6 py-4 text-center text-sm border border-gray-200">
