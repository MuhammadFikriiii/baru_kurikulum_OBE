            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 pt-6">
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <select name="id_jurusan" id="id_jurusan" class="w-full p-3 border border-gray-300 rounded-lg" required>
                            @foreach ($jurusans as $jurusan)
                                <option value="{{ $jurusan->id_jurusan }}" {{ $prodi->id_jurusan == $jurusan->id_jurusan ? 'selected' : '' }}>
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <select name="peringkat_akreditasi" class="w-full p-3 border border-gray-300 rounded-lg" required>
