...
@section('content')
    ...
    <div class="container mx-auto px-4">
        ...
        <div class="flex flex-col md:flex-row justify-between mb-6">
            ...
            <form method="GET" action="{{ route('admin.dashboard') }}" class="w-full md:w-64 border border-black px-4 py-2 rounded-md pl-10 focus:outline-none focus:ring-2 focus:ring-green-500">
