                ...
                <div class="">
                    <table class="min-w-full divide-y divide-gray-200">
                        <thead class="bg-green-800 text-white ">
                            <tr>
                                <th class="px-4 py-3 text-left text-xs font-medium uppercase tracking-wider">CPL</th> 
                                @foreach ($mks as $mk)
                                <th class="px-4 py-3 text-center text-xs font-medium uppercase tracking-wider relative group">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            @foreach ($cpls as  $index => $cpl)
                                <tr class="{{ $index % 2 == 0 ? 'bg-gray-100' : 'bg-white' }} hover:bg-gray-200 border">
                                    <td class="px-4 py-4 whitespace-nowrap relative group">
