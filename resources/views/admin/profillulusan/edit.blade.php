...
<form action="{{ route('admin.profillulusan.update', $profillulusan->kode_pl) }}" method="POST">
    ...
    <input type="text" name="kode_pl" id="kode_pl" value="{{ old('kode_pl', $profillulusan->kode_pl) }}" required>
    <br>

    <label for="kode_prodi">Program Studi:</label>
    <select name="kode_prodi" id="kode_prodi" required>
    ...
    <textarea name="deskripsi_pl" id="deskripsi_pl" required>{{ old('deskripsi_pl', $profillulusan->deskripsi_pl) }}</textarea>
    <br>

    <label for="profesi_pl">Profesi Profil Lulusan:</label>
    <textarea name="profesi_pl" id="profesi_pl" required>{{ old('profesi_pl', $profillulusan->profesi_pl) }}</textarea>
    <br>

    <label for="unsur_pl">Unsur PL:</label>
    <select name="unsur_pl" id="unsur_pl" required>
    ...
    <select name="keterangan_pl" id="keterangan_pl" required>
    ...
    <textarea name="sumber_pl" id="sumber_pl" required>{{ old('sumber_pl', $profillulusan->sumber_pl) }}</textarea>
    <br>
