...
<form action="{{ route('admin.profillulusan.update', $profillulusan->id_pl) }}" method="POST">
    ...
    <button type="submit" class="bg-blue-600 hover:bg-blue-800 px-5 py-2 text-white font-bold rounded-lg">Simpan</button>
    <a href="{{ route('admin.profillulusan.index') }}" class="ml-2 bg-gray-600 hover:bg-gray-700 px-5 py-2 text-white font-bold rounded-lg">Kembali</a>
</form>
</div>
@endsection