...
<button type="submit" class="bg-blue-600 hover:bg-blue-800 mt-3 px-5 py-2 text-white font-bold rounded-lg">Simpan</button>
<a href="{{ route('admin.profillulusan.index') }}" class="ml-2 bg-gray-600 hover:bg-gray-800 mt-3 px-5 py-2 text-white font-bold rounded-lg">Kembali</a>
</form>
</div>
@endsection