                    ...
                    <tbody>
                        @foreach ($profillulusans as $index => $profillulusan)
                            <tr class="align-top {{ $index % 2 == 0 ? 'bg-gray-50' : 'bg-white' }} hover:bg-gray-100">
                                ...
                                <td class="px-4 py-2 w-16 text-center border border-gray-300">{{ $profillulusan->kode_pl }}</td>
                                <td class="px-4 py-2 w-24 text-center border border-gray-300">{{ $profillulusan->prodi->nama_prodi ?? '-' }}</td>
                                ...
                                <td class="px-4 py-2 w-32 text-justify border border-gray-300">{{ $profillulusan->unsur_pl }}</td>
                                <td class="px-4 py-2 w-28 text-center border border-gray-300">{{ $profillulusan->keterangan_pl }}</td>
                                <td class="px-4 py-2 w-40 text-justify border border-gray-300">{{ $profillulusan->sumber_pl }}</td>
