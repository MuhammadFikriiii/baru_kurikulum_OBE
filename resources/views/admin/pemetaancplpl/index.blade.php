        ...
        <thead class="bg-green-500">
            <tr>
                ...
                <th class="px-2 py-2 relative group">
                    ...
                    <div class="mt-2 absolute left-1/2 -translate-x-[60%] top-full hidden group-hover:block w-64 bg-gray-700 text-white text-sm rounded p-2 z-50 text-center">
                        {{ $pl->deskripsi_pl }}
                    </div>
                ...
                <tr class="border-b">
                    ...
                    @foreach ($pls as $pl)
                        <td class="px-4 py-2 text-center">
                            <input type="checkbox" name="relasi[{{ $pl->id_pl }}][]" value="{{ $cpl->kode_cpl }}" 
                                {{ isset($relasi[$pl->id_pl]) && in_array($cpl->kode_cpl, $relasi[$pl->id_pl]->pluck('kode_cpl')->toArray()) ? 'checked' : '' }} 
