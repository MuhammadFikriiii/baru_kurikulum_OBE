                                ...
                                @foreach ($VisiMisis as $index => $visimisi)
                                    <tr class="{{ $index % 2 == 0 ? 'bg-gray-50' : 'bg-white' }} hover:bg-gray-100">
                                        ...
                                        <td class="px-6 py-4 text-center border border-gray-200">
                                            {{ $visimisi->visi }}</td>
                                        <td class="px-6 py-4 text-center border border-gray-200">{{ $visimisi->misi }}
                                        </td>
                                        <td class="px-6 py-4 border border-gray-200">
                                            <div class="flex justify-center space-x-2">
                                                <a href="{{ route('admin.visimisi.detail', $visimisi->id) }}"
                                                ...
                                                <form action="#"
                                                    ...
                                                    <button type="submit"
                                                        ...
                                                        title="Hapus" onclick="return confirm('Hapus visi & misi ini?')">
                                                        <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4"
                                                            viewBox="0 0 20 20" fill="currentColor">
                                                            <path fill-rule="evenodd"
