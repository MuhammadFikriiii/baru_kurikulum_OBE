...
<div class="bg-white p-4 md:p-6 lg:p-8 rounded-lg shadow-md mx-2 md:mx-0">
    <div class="text-center mb-6 md:mb-8">
        <h1 class="text-xl md:text-2xl font-bold text-gray-700">Data User</h1>
            ...
            <table class="w-full border border-gray-300 rounded-lg overflow-hidden shadow-md">
                <thead class="bg-green-800 text-white">
                    <tr>
                        ...
                        <th class="px-3 py-2 md:px-6 md:py-3 text-center text-xs md:text-sm font-medium uppercase border-r border-gray-200">Nama</th>
                        <th class="px-3 py-2 md:px-6 md:py-3 text-center text-xs md:text-sm font-medium uppercase border-r border-gray-200">Email</th>
                        <th class="px-3 py-2 md:px-6 md:py-3 text-center text-xs md:text-sm font-medium uppercase border-r border-gray-200">Prodi</th>
                        <th class="px-3 py-2 md:px-6 md:py-3 text-center text-xs md:text-sm font-medium uppercase border-r border-gray-200">Role</th>
                        <th class="px-3 py-2 md:px-6 md:py-3 text-center text-xs md:text-sm font-medium uppercase border-r border-gray-200">Status</th>
                ...
                <tbody>
                    ...
                    <tr class="{{ $index % 2 == 0 ? 'bg-gray-50' : 'bg-white' }} hover:bg-gray-100">
                        <td class="px-3 py-2 md:px-6 md:py-4 text-center border border-gray-200 text-xs md:text-sm">{{ $index + 1 }}</td>
                        <td class="px-3 py-2 md:px-6 md:py-4 text-center border border-gray-200 text-xs md:text-sm">{{ $user->name }}</td>
                        <td class="px-3 py-2 md:px-6 md:py-4 text-center border border-gray-200 text-xs md:text-sm">{{ $user->email }}</td>
                        <td class="px-3 py-2 md:px-6 md:py-4 text-center border border-gray-200 text-xs md:text-sm">{{ $user->prodi->nama_prodi ?? '-' }}</td>
                        <td class="px-3 py-2 md:px-6 md:py-4 text-center border border-gray-200 text-xs md:text-sm">{{ ucfirst($user->role) }}</td>
                        <td class="px-3 py-2 md:px-6 md:py-4 text-center border border-gray-200">
