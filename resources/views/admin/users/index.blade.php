            ...
            <table class="w-full border border-gray-300 rounded-lg overflow-hidden shadow-md">
                <thead class="bg-green-800 text-white">
                    <tr>
                        ...
                        <th class="px-6 py-3 text-center font-medium uppercase border-r border-gray-200">Nama</th>
                        <th class="px-6 py-3 text-center font-medium uppercase border-r border-gray-200">Email</th>
                        <th class="px-6 py-3 text-center font-medium uppercase border-r border-gray-200">Prodi</th>
                        <th class="px-6 py-3 text-center font-medium uppercase border-r border-gray-200">Role</th>
                        <th class="px-6 py-3 text-center font-medium uppercase border-r border-gray-200">Status</th>
                        ...
                        <td class="px-6 py-4 border border-gray-200">
                            <div class="flex justify-center space-x-2">
                                <a href="{{ route('admin.users.detail',$user->id) }}" 
                                    class="bg-gray-600 hover:bg-gray-700 text-white p-2 rounded-md w-10 h-10 flex items-center justify-center" 
                                    title="Detail">
                                ...
                                <a href="{{ route('admin.users.edit', $user->id) }}" 
                                    class="bg-blue-600 hover:bg-blue-800 text-white p-2 rounded-md w-10 h-10 flex items-center justify-center" 
                                    title="Edit">
                                ...
                                <form action="{{ route('admin.users.destroy', $user->id) }}" method="POST">
                                    @csrf @method('DELETE')
                                    <button type="submit" 
                                            class="bg-red-500 hover:bg-red-600 text-white p-2 rounded-md w-10 h-10 flex items-center justify-center" 
                                            title="Hapus" 
