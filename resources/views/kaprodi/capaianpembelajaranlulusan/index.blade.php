                ...
                <tbody>
                    ...
                    <tr class="{{ $index % 2 == 0 ? 'bg-gray-100' : 'bg-white' }} hover:bg-gray-200 border-b">
                        ...
                        <td class="py-3 px-6 min-w-[10px] flex justify-center items-center space-x-2">
                            <a href="{{ route('kaprodi.capaianpembelajaranlulusan.detail', $capaianpembelajaranlulusan->id_cpl) }}" class="bg-gray-600 font-bold text-white px-5 py-3 rounded-md hover:bg-gray-800">🛈</a>
                        </td>
                    </tr>
                    @endforeach
                </tbody>
